...
public class GetIndivCustomers {
	
	static String TestDataTab = "productGET";
	...
	public GetIndivCustomers(Map<Object, Object> testdatamap) {
	...
	@Test
	public void testpostIndivCustomers() throws Exception {
		try {
			CustomerMethods.Customer(testdatamap);;		
	...
	public void setup() throws Exception {
		...
		test = ExtentReportManager.CreateExtentReportTest(extent, className, testdatamap.get("TestDescription").toString(),
				TestScriptID);
		CustomerMethods= new CustomerMethods(test);
		Log =new Log(test);
