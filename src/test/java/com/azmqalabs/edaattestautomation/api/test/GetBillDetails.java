...
public class GetBillDetails {
	...
	static String TestDataTab = "BillsGET";
	...
	ExtentTest test;
	BillsMethods BillsMethods;
	Log Log;

	@Factory(dataProvider = "TestDataProvider")
	public GetBillDetails(Map<Object, Object> testdatamap) {
	...
	public void testCityCode() throws Exception {
		try {
			...
			BillsMethods.Bills(testdatamap);
	...
	public void setup() throws Exception {
		...
		test = ExtentReportManager.CreateExtentReportTest(extent, className, testdatamap.get("TestDescription").toString(),
				TestScriptID);
		BillsMethods = new BillsMethods(test);
		Log =new Log(test);
