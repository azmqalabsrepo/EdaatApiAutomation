...
public class PostSubBiller {
	
	static String TestDataTab = "subbillerPOST"; 
	...
	ExtentTest test;
	Log Log;
	SubBillerMethods SubBillerMethods;

	@Factory(dataProvider = "TestDataProvider")
	public PostSubBiller(Map<Object, Object> testdatamap) {
	...
	public void testpostProduct() throws Exception {
		try {
			SubBillerMethods.SubBiller(testdatamap);		
			test.log(Status.PASS, "SubBiller Has been Created");
	...
	public void setup() throws Exception {
		...
		test = ExtentReportManager.CreateExtentReportTest(extent, className, testdatamap.get("TestDescription").toString(),
				TestScriptID);
		SubBillerMethods= new SubBillerMethods(test);
		Log =new Log(test);
